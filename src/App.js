import { Header,Button,Form,TextArea,Container} from 'semantic-ui-react';
require("./App.css")    ;
    ...
    render() {
        ...
        return (
            <Container className="App">
                <br/>
                <br/>
                <Header as='h1' block id="tit">
                    Rinkeby测试网络钱包
                </Header>

                <Button onClick={this.generateMnemonic}>点击获取助记词</Button>&nbsp;&nbsp;
                <Button onClick={this.generatePubAndPrivFromMnemonic}>根据助记词生成帐号</Button>
                <br/>
                <br/>
                <Form>
                    <TextArea autoHeight placeholder='有助记词?输入助记词' onChange={this.onMnemonicTextareaChange} value={this.state.mnemonic}/>
                </Form>
                ...
                <Form>
                    <TextArea autoHeight placeholder='你的公钥' value={this.state.account} disabled="true"/>
                </Form>
